...
```{r transformation}
# Example: Transform Shannon to Simpson and Chao1
source_metrics <- data.frame(
  shannon = c(2.1, 2.5, 1.8, 2.3, 2.7),
...
quality <- attr(transformed, "quality")
print(quality)
```
...
relationships <- discover_metric_relationships(GlobalPatterns)

# Visualize as network
plot_diversity_network(relationships, layout = "force")
```
